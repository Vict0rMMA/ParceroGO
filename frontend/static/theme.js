...
(function () {
    ...
    window.i18n = {
        es: {
            nav_inicio: 'Inicio', nav_delivery: 'Delivery', nav_jumbo: '', nav_tracking: 'Seguimiento',
            nav_perfil: 'Perfil', nav_panel: 'Panel', nav_repartidor: 'Repartidor',
        ...
        en: {
            nav_inicio: 'Home', nav_delivery: 'Delivery', nav_jumbo: '', nav_tracking: 'Tracking',
            nav_perfil: 'Profile', nav_panel: 'Panel', nav_repartidor: 'Courier',
